...
and two impurities at the middle of the chain. In
...
modpar_keys: list
    ...
    Heisenberg model:
    'J', 'dJ', 'delta', 'ddelta', 'W1', 'dW1', 'W2', 'dW2', 'noise: float
    ...
    disorder distribution, respectively -> for two
    impurities in the middle of the chain, which is
    designated by the 1 and 2 suffixes.
...
modpar_keys = ['J', 'dJ', 'delta', 'ddelta',
               'W1', 'dW1', 'W2', 'dW2', 'noise'] + comm_modpar_keys
...
def construct_hamiltonian(argsdict, parallel=False, mpirank=0, mpisize=0):
    ...
    fields = get_disorder_dist(L, disorder, argsdict['W1'],
                               argsdict['dW1'], argsdict['seed'],
                               loc=int(L * 0.5) - 1)

    fields += get_disorder_dist(L, disorder, argsdict['W2'],
                                argsdict['dW2'], argsdict['seed'],
                                loc=int(L * 0.5))
