...
programs = {
    ...
    'gaps_microcan': {'name': f'{_mainfold}main_r_microcan.py', 'array': False,
                      'save': 'Spectral_stats', 'vectors': False,
                      'noqueue': False, 'mpi': False,
                      'short': None, 'postprocess': True},
    ...
    'gamma_partial': {'name': f'{_mainfold}main_gamma_partial.py',
                      ...
                      'noqueue': False, 'mpi': False,
                      'short': None, 'postprocess': True},
    'microcan_partial': {'name': f'{_mainfold}main_deltae_microcan.py',
                         'array': False,
                         'save': 'Spectral_stats', 'vectors': False,
                         'noqueue': False, 'mpi': False,
                         'short': None, 'postprocess': True},
    ...
    'sinvert_short': {'name': f'{_mainfold}main_sinvert_short.py',
                      ...
                      'mpi': True, 'short': True,
                      'postprocess': False},
    'sinvert_f_scaling': {'name': f'{_mainfold}main_sinvert_f_scaling.py', 'array': True,
                          'save': 'Eigvals', 'vectors': True,
                          'noqueue': False, 'mpi': True,
                          'short': False, 'postprocess': False},
    'thouless_diag': {'name': f'{_mainfold}main_thouless_conductivity_diag.py',
                      'array': True,
                      'save': 'Eigvals', 'vectors': True,
                      'noqueue': False, 'mpi': False,
                      'short': True, 'postprocess': False},
    'thouless_inter_diag':
    {'name':
     f'{_mainfold}main_thouless_conductivity_interacting_diag.py',
     'array': True,
     'save': 'Eigvals', 'vectors': True,
     'noqueue': False, 'mpi': False,
     'short': True, 'postprocess': False},
    ...
    'and_matelts_variance_alt': {'name': f'{_mainfold}main_matelts_variance_ratio_partial_alt.py',
                                 'array': False,
                                 'save': 'Spectral_stats', 'vectors': False,
                                 'noqueue': False, 'mpi': False,
                                 'short': True, 'postprocess': True},
    ...
    'and_mb_eentro_scaling_external': {'name': f'{_mainfold}main_anderson_entro_scaling_analysis.py',
                                       ...
                                       'noqueue': False, 'mpi': False,
                                       'short': True, 'postprocess': True},
    'inter_eentro_scaling_external': {'name': f'{_mainfold}main_general_entro_scaling_analysis.py',
                                      'array': False,
                                      'save': 'Spectral_stats', 'vectors': False,
                                      'noqueue': False, 'mpi': False,
                                      'short': True, 'postprocess': True}
